...
const H3 = ({ hash, tokens }: Tokens.Heading) => {
  ...
  return (
    <div className="flex items-center mt-4 mb-2" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
      <h3 className="text-2xl font-bold" id={hash}><TokensRenderer tokens={tokens}/></h3>
      <a className={`${!open && 'hidden'}`} href={`#${hash}`}>
	<svg className="fill-blue-500 dark:fill-gray-300 pl-2 mt-1" height="1em" viewBox="0 0 12 6">
