...
export const HeaderNavbarDropdown = () => {
  ...
  return (
	...
	<Link className="block text-gray-700 font-bold px-3 py-2 hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-neutral-600" to="/markdown" onClick={handleClick}>
	  Markdown
	  <p className="text-xs font-thin">Markdown</p>
	</Link>
